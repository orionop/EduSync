  ...
  return (
    <div className="h-screen w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <Link 
          to="/marks-calculation" 
          className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
            isActive('/marks-calculation') 
              ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' 
              : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'
          }`}
        >
        ...
        <Link 
          to="/end-semester-evaluation" 
          className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
            isActive('/end-semester-evaluation') 
              ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' 
              : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'
          }`}
        >
