...
import { LayoutDashboard, Calendar, Award, RefreshCw, MoreHorizontal } from 'lucide-react';

const StudentBottomNav: React.FC<{ onMoreClick: () => void }> = ({ onMoreClick }) => {
  const location = useLocation();

  const navItems = [
    { path: '/student/dashboard', icon: LayoutDashboard, label: 'Home' },
    { path: '/student/exam-timetable', icon: Calendar, label: 'Schedule' },
    { path: '/student/results', icon: Award, label: 'Results' },
    { path: '/student/kt-section', icon: RefreshCw, label: 'KT' },
  ];
