...
const CollegeBanner: React.FC<CollegeBannerProps> = ({ 
  ...
  return (
    <div className="w-full bg-gradient-to-r from-green-600/90 to-green-800/90 text-white py-3 px-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-green-100">Faculty Portal</p>
          </div>
        </div>
        
        <div className="hidden md:block text-right">
          <p className="text-sm text-green-100">Academic Year 2025-2026</p>
          <p className="text-xs text-green-200">Spring Semester</p>
        </div>
      </div>
    </div>
  );
