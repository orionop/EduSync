...
import { Notification, NotificationCategory } from '../../context/NotificationContext';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full overflow-hidden modal-animate-in">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white flex items-center">
            {getHeaderIcon()}
            {notification.type === 'announcement' ? 'Announcement Details' : 'Time Slot Change Request'}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-6 mb-4">
            ...
            <p>Received: {new Date(notification.timestamp).toLocaleString()}</p>
          </div>
