...
import ThemeToggle from '../../components/faculty/ThemeToggle';
import UFMReportModal from '../../components/faculty/UFMReportModal';
import UserProfileModal from '../../components/faculty/UserProfileModal';
...
const CameraFeed: React.FC = () => {
  ...
  const handleBack = () => {
    navigate('/faculty/proctor-section');
  };
